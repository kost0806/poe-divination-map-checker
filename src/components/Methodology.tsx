...
export function Methodology({ dataset }: Props) {
  ...
  return (
    <div className="prose">
      ...
      <p>
        <b>예지할 수 있는 지도만 다룬다.</b> 17등급 지도(성역·성채·요새·흉물·지구라트)와 아틀라스에 없어
        자나 기억으로만 들어가는 지도(허비의 안뜰·부정의 석실·거짓의 극장)는 선호 지도로 지정할 수 없어
        비교에서 뺐고, 고유 지도도 마찬가지다. 지도 아이템에 붙는 인챈트("지도가 태초자의 영향을 받음"
        등)는 지도 베이스가 아니라 카드 풀을 바꾸지 않으므로, 그런 지도도 같은 이름의 지도로 보면 된다.
      </p>
