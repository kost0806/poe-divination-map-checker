...
시간당 수익 = 1회당 수익 × 60 / 소요 분_m`}</pre>
      <p>
        <code>A</code>는 모든 지도에 동일하게 곱해지므로 <b>지도 간 순위에는 영향이 없다.</b> 카오스 오브
      ...
      <ul>
        <li>
          ...
          순위와 배율은 유효하지만 "1회당 몇 카오스 오브"라는 숫자 자체는 가정에 의존한다. 지도 상세의
          실측 보정으로 직접 맞출 수 있다.
        </li>
        <li>
        ...
        <li>
          <b>아틀라스 특성·갑충석·지도 접두어를 반영하지 않는다.</b> 실제로는 점술 카드 관련 아틀라스
          특성 투자가 수익을 크게 바꾼다. 여기 값은 그런 투자 없이 지도 자체만 비교한 것이다.
        </li>
        <li>
